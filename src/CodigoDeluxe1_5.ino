...
avanza(200);
  ...
  switch (Switch) {
    case 1: // Gira a la izquierda y centra
      paredder();
      break;
    case 2: // Gira a la derecha y centra
      paredizq();
      break;
    case 3: // Corrección derecha
      correccionIzquierda();
      break;
    case 4: // Corrección izquierda
      correccionDerecha();
      break;
    case 5: // Corrección frontal bandera 1
      correccionFrontalBandera1();
      break;
    case 6: // Corrección frontal bandera 2
      correccionFrontalBandera2();
      break;
    default:
      avanza(100);   // Comportamiento por defecto, por ejemplo avanzar
      break;
  }
 }
