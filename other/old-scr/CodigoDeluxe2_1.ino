...
int objetoDelante = 90; //Si el sensor frontal detecta a menos de esto, es hora de decidir un giro
int paredCerca = 35; // Distancia para considerar que una pared lateral está "cerca"
int paredLejos = 50; //Distancia para considerar que una pared lateral está "lejos" o el pasillo "abierto"
